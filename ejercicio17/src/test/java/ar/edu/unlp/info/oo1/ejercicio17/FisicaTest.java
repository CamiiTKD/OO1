...
public class FisicaTest{
	...
	void setUp() {
		...
		clienteSinLlamadas = new Fisica("Juan", "522 nro 1927", "46.132.564");
		clienteConLlamadas = new Fisica("Cami", "522 nro 1927", "45.131.859");
	...
	void testFacturar() {
		...
		assertEquals(252d, clienteConLlamadas.facturar(LocalDate.of(2020, 1, 1), LocalDate.of(2024, 1, 1)).getMonto());
	}
