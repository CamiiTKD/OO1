...
public class ListaDeEnterosEnlazada extends ListaDeEnteros {
	...
	public void calcularSucesion(int contador, ListaDeEnterosEnlazada l, int n) {
		contador++;
		l.agregarEn(n, contador);
		if(n != 1) {
			if( (n%2) == 0) {
				calcularSucesion(contador, l, n/2);
		}
			else
				calcularSucesion(contador, l, 3*n + 1);
		}
	}
}
